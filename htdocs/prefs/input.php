...
<div class="col-md-3">  </div>
    ...
    <p> Pref List Filler Text </p>
     ...
     $res2 = $sql->queryJSON("select officer from nextGen.users where username = '" . $_SESSION["uname"] . "';");
        ...
        if ($res1 == "TRUE") { // if they are an owner, then display a page to submit a preference list of officers
        	include "./officer_preference.php";
        }
        if ($res2 == "TRUE") { // if they are an officer, then display a page to submit a preference list of assignments
