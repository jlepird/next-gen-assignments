...
<div class="col-md-3">  </div>
    ...
    <br> <br> <br>
    <h3>Instructions</h3>
    <p>As an officer on the VML, you are required to update your profile on MyVector by 31 Jan 17. There you will be able to update your duty experience, skills, training, and education.  Having a detailed profile allows billet owners to have a better understanding of you as an officer as they search for the right person for their billet.  Follow the following tutorial on how to update your profile in MyVector.</p>
...
<p>You will need to create an account if you do not already have one.</p><br>
...
<br><img src="self_reported_skills.JPG" alt="SELF-REPORTED SKILLS"  style="padding:2px;border:thin solid black;">
...
<p>This section allows you to view a summary of your education and training information. You will have the ability to view the following tables with associated information:</p>
<UL>
...
<p>You are also able to add additional education experience that is not automatically pulled from DCPDS, as shown below.</p>
...
<p>This section allows you to update your job preferences, update your desire for training and education, and update your career goals. Just click "Development Plan" in the MyVector Dashboard.  Be sure to click the "Save" button in each tab after making changes.</p>

<br><br><img src="development plan.JPG" alt="Development Plan"  style="padding:2px;border:thin solid black;">

<br><br>
<p>The "Job Preferences" tab displays your job preferences to be considered by the Development Teams during the vectoring process.</p>

<br><img src="job pref.bmp" alt="Job Preferences"  style="padding:2px;border:thin solid black;"><br><br>

<p>The "Developmental Education" tab allows you to update your desire for training and/or Professional Military Education programs. You can enter your developmental education goals as well as recommended text for your Senior Rater to use in their endorsement comments when you meet a board. You will also be able to update your desired PME course. You can also view your current and historical Developmental Education boards by selecting “Click Here”. NOTE: If you are a Captain or Major you will also be able to update you Advanced Studies Group intent on this tab. </p>

<br><img src="dev edu.bmp" alt="Development Education"  style="padding:2px;border:thin solid black;"><br><br>

<p>The "Intent & Comments" tab allows you to outline any relevant details concerning your career plans, goals, answering developmental team group intent questions, and any other information you would like leadership to know about.</p>

<br><img src="intent.bmp" alt="Intent and Comments"  style="padding:2px;border:thin solid black;">
